...
class QuikTikApp extends ConsumerStatefulWidget {
  const QuikTikApp({super.key});

  @override
  ConsumerState<QuikTikApp> createState() => _QuikTikAppState();
}

class _QuikTikAppState extends ConsumerState<QuikTikApp> {
  ...
  Widget build(BuildContext context) {
    // Ensure core services are pre-warmed when the app starts.
