...
class AppLocalizations {
  ...
  String get selectProvince => _localizedValue('selectProvince', 'Select Province', 'Sélectionnez une Province');
  String get selectCity => _localizedValue('selectCity', 'Select City', 'Sélectionnez une Ville');
  String get findLocations => _localizedValue('findLocations', 'Find Locations', 'Trouver des Emplacements');
  String get joinQueue => _localizedValue('joinQueue', 'Join the Queue', 'Accéder à la File');
  String get searchEstablishments => _localizedValue('searchEstablishments', 'Search establishments...', 'Rechercher des établissements...');
  String get establishmentsFound => _localizedValue('establishmentsFound', 'establishments found', 'établissements trouvés');
  String get currentlyClosed => _localizedValue('currentlyClosed', 'Currently Closed', 'Actuellement Fermé');
  String get estimatedWait => _localizedValue('estimatedWait', 'Estimated wait time: 15-20 minutes', 'Temps d\'attente estimé: 15-20 minutes');
  String get queueSuccess => _localizedValue('queueSuccess', 'Successfully joined queue', 'Rejoint avec succès la file');
  
  // Confirmation dialog
  String get confirmSelection => _localizedValue('confirmSelection', 'Confirm Selection', 'Confirmer la Sélection');
  String get youHaveSelected => _localizedValue('youHaveSelected', 'You have selected', 'Vous avez sélectionné');
  String get yes => _localizedValue('yes', 'Yes', 'Oui');
  String get no => _localizedValue('no', 'No', 'Non');
  String get activeTickets => _localizedValue('activeTickets', 'Active Tickets', 'Billets Actifs');
